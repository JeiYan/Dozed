...
<head>
    ...
    <title>Dozed | Great Coffee, Good Coffee</title>
            ...
            <div class="nav-bar">
                <div class="brand">
                    <a class="nav-link" href="../home/home.php#hero">
                        <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;border-radius: 12px;"> Dozed</h1><span
                            class="sr-only"></span>
                    </a>
                </div>
                <div class="nav-list">
...
?>
<li>
    <a href="<?= strpos($current_url, "localhost/dozed/customerSide/home/home.php") !== false ? "#hero" : "/dozed/customerSide/home/home.php" ?>" data-after="Home">Home</a>
</li>

<?php if (strpos($current_url, "localhost/dozed/customerSide/home/home.php") !== false): ?>
    <li><a href="#projects" data-after="Projects">Menu</a></li>
    <li><a href="#about" data-after="AboutUs">About Us</a></li>
    <li><a href="#contact" data-after="Contact">Contact</a></li>
<?php endif; ?>

<!-- Show Reservation on ALL pages -->
<li>
    <a href="/dozed/customerSide/CustomerReservation/reservePage.php" data-after="Service">Reservation</a>
</li>
...
$result = mysqli_query($link, $query);
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            $vip_tooltip = ($vip_status === 'Regular') ? ($points < 1000 ? (1000 - $points) . ' points to Premium ' : 'You are eligible for Premium') : '';
