...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Dozed Admin</title>
        ...
        <link rel="icon" type="image/png" href="/dozed/customerSide/image/logo.png">
    ...
    .header {
        background-color: #4e342e; /* Deep coffee brown */
        color: #fff;
        padding: 1rem 2rem;
        display: flex;
    ...
    .nav a.active {
        background-color: #a1887f; /* Selected tab */
        color: #fff;
        font-weight: bold;
    }
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../panel/pos-panel.php">Dozed's Staff Panel</a>
