          ...
          <div class="d-md-flex">
            ...
            <div class="form-group ml-md-4">
              <?php if (isset($_SESSION['user_id'])) { ?>
                <button type="submit" name="submit" class="btn btn-white py-3 px-4">Book a Table or Cubicle</button>
              <?php } else { ?>
                <a href="auth/login.php" class="btn btn-white py-3 px-4">Login to Book a Table or Cubicle</a>
              <?php } ?>
            </div>
          </div>
        </form>
